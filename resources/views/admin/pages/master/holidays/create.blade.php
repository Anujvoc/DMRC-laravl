...
<div class="app-wrapper">
    <div class="app-page-head d-flex flex-wrap gap-3 align-items-center justify-content-between">
        <div class="clearfix">
            <h1 class="app-page-title">Add Holiday</h1>
            <span>Create a new holiday</span>
        </div>
        ...
        <div class="col-lg-8">
            <div class="card border shadow-sm">
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('admin.master.holidays.store') }}">
                        @csrf
                        <div class="row g-4">
                            <!-- Holiday Information -->
                            ...
                            <div class="col-12">
                                <div class="d-flex gap-2 justify-content-end mt-4">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fi fi-rr-save me-1"></i> Save Holiday
                                    </button>
                                </div>
                            </div>
                        </div>
