  ...
  <div class="app-wrapper">
    <div class="app-page-head d-flex flex-wrap gap-3 align-items-center justify-content-between">
      <div class="clearfix">
        ...
        <span>Feb 03, 2026 - Mar 03, 2026</span>
      </div>
      <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#addStudentModal">
        <i class="fi fi-rr-plus me-1"></i> Add Student
      </button>
    </div>
          ...
          <div class="col-6 col-md-4 col-lg">
            <div class="card bg-success bg-opacity-05 shadow-none border-0">
              <div class="card-body">
                ...
                <small class="fw-medium">
                  <span class="text-success">
                    <i class="fi fi-rr-arrow-small-up scale-3x"></i> +8.1%
                  </span> Last Month
                </small>
              </div>
            </div>
          ...
          <div class="col-6 col-md-4 col-lg">
            <div class="card bg-warning bg-opacity-05 shadow-none border-0">
              <div class="card-body">
                ...
                <small class="fw-medium">
                  <span class="text-success">
                    <i class="fi fi-rr-arrow-small-up scale-3x"></i> +2.4%
                  </span> Last Month
                </small>
              </div>
            </div>
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <div class="avatar avatar-xs bg-primary rounded-circle text-white me-2">
                              A
                            </div>
                            Admin User
                          </div>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <div class="avatar avatar-xs bg-info rounded-circle text-white me-2">
                              S
                            </div>
                            Student User
                          </div>
                        </td>
                        <td>Enrolled in new course</td>
                        <td>Feb 03, 2026 12:30</td>
          ...
          <div class="card-body">
            <div class="d-grid gap-2">
              <a href="#" class="btn btn-outline-primary">
                <i class="fi fi-rr-user-plus me-2"></i> Add User
              </a>
              <a href="#" class="btn btn-outline-success">
                <i class="fi fi-rr-user-add me-2"></i> Add Student
              </a>
              <a href="#" class="btn btn-outline-info">
                <i class="fi fi-rr-book me-2"></i> Add Course
              </a>
              <a href="#" class="btn btn-outline-warning">
                <i class="fi fi-rr-chart-pie-alt me-2"></i> View Reports
              </a>
            </div>
          </div>
        </div>
